...
Generate content for section `section-08-policy` (filename: `section-08-policy.md`).
...
for `section-08-policy` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-08-policy.md`
