...
Generate content for section `section-06-config-watcher` (filename: `section-06-config-watcher.md`).
...
for `section-06-config-watcher` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-06-config-watcher.md`
