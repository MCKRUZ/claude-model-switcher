...
Generate content for section `section-04-proxy-phase0` (filename: `section-04-proxy-phase0.md`).
...
for `section-04-proxy-phase0` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-04-proxy-phase0.md`
