...
Generate content for section `section-05-cli-start-and-ports` (filename: `section-05-cli-start-and-ports.md`).
...
for `section-05-cli-start-and-ports` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-05-cli-start-and-ports.md`
