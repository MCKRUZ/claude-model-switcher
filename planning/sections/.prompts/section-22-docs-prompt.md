...
Generate content for section `section-22-docs` (filename: `section-22-docs.md`).
...
for `section-22-docs` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-22-docs.md`
