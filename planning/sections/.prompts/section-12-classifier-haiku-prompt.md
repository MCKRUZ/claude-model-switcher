...
Generate content for section `section-12-classifier-haiku` (filename: `section-12-classifier-haiku.md`).
...
for `section-12-classifier-haiku` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-12-classifier-haiku.md`
