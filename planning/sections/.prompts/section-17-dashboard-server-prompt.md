...
Generate content for section `section-17-dashboard-server` (filename: `section-17-dashboard-server.md`).
...
for `section-17-dashboard-server` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-17-dashboard-server.md`
