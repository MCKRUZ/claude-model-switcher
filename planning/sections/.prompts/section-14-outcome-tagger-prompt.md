...
Generate content for section `section-14-outcome-tagger` (filename: `section-14-outcome-tagger.md`).
...
for `section-14-outcome-tagger` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-14-outcome-tagger.md`
