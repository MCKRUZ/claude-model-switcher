...
Generate content for section `section-03-config` (filename: `section-03-config.md`).
...
for `section-03-config` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-03-config.md`
