...
Generate content for section `section-21-release-ci` (filename: `section-21-release-ci.md`).
...
for `section-21-release-ci` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-21-release-ci.md`
