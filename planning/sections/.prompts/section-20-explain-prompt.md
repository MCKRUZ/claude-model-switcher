...
Generate content for section `section-20-explain` (filename: `section-20-explain.md`).
...
for `section-20-explain` to understand what this section should contain.
...
`C:\Users\kruz7\OneDrive\Documents\Code Repos\MCKRUZ\claude-model-switcher\planning/sections/section-20-explain.md`
